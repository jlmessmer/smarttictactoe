...
def disp_help():
    print "To make a move, input the desired square as [row][column]"
    print "Ex. 11 corresponds to the top left square. 21 corresponds to the square below it"
    raw_input("Press any key to return")
    cls()
    main()
    
def disp_credits():
    print "Created by Jimmy Messmer"
    print "(C) 2015 Jimmy Messmer"
    raw_input("Press any key to return")
    cls()
    main()
...
def main():
    ...
    if(option == 1):        
        ...
        #Once the game is over, then print this and restart the main loop:
